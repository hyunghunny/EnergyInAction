...
$(function () {
  ...
  var LAST_SEASON_WEEKDAY_COM   = MARG_LAST_SEASON_WEEKDAY[95].computer;
  var LAST_SEASON_WEEKDAY_LIGHT = MARG_LAST_SEASON_WEEKDAY[95].light;
  var LAST_SEASON_WEEKDAY_HVAC  = MARG_LAST_SEASON_WEEKDAY[95].hvac;

  var LAST_SEASON_WEEKEND_COM   = MARG_LAST_SEASON_WEEKEND[95].computer;
  var LAST_SEASON_WEEKEND_LIGHT = MARG_LAST_SEASON_WEEKEND[95].light;
  var LAST_SEASON_WEEKEND_HVAC  = MARG_LAST_SEASON_WEEKEND[95].hvac;
  ...
  thisWeek_query = 'api/labs/marg/energy/daily.json?day_from=' + DAY_FROM_MANUALLY + '&day_to=' + dateFormatter(new Date(query_yesterday)) + '&offset=0';
  // thisWeek_query = 'api/labs/marg/energy/daily.json?day_from=' + dateFormatter(new Date(firstDayOfThisMonth)) + '&day_to=' + dateFormatter(new Date(yesterDay)) + '&offset=0';
  // thisWeek_query = 'api/labs/marg/energy/daily.json?day_from=' + '2015-12-01' + '&day_to=' + '2015-12-31' + '&offset=0';
