...
$(function () {
    ...
    for(var index = 0; index < TARGET.length; index++){
      ...
      // lastSeason_total.push(Number(total.toFixed(2)));
      lastSeason_hvac.push(Number(hvac.toFixed(2)));
      lastSeason_com.push(Number(com.toFixed(2)));
      lastSeason_light.push(Number(light.toFixed(2)));
      // lastSeason_etc.push(Number(etc.toFixed(2)));
    }

    // var lastSeason_totalSum = limitedArraySum(lastSeason_total, 96)

    // console.log("lastSeason_total",lastSeason_total);
    ...
    function drawChart(){
      ...
      var lastSeason_maxFeederValue = Math.max(limitedArraySum(lastSeason_com, todayLength), limitedArraySum(lastSeason_light, todayLength), limitedArraySum(lastSeason_hvac, todayLength));
      ...
      var savingPoints = limitedArraySum(lastSeason_hvac, todayLength) - limitedArraySum(today_hvac, todayLength);
      var signColorCode;
      ...
      // console.log(lastSeason_totalSum);
      // console.log(limitedArraySum(lastSeason_total, todayLength));

      $('#ux_comparison_hvac').highcharts({
        chart: {
            type: 'column',
            uxinTop: 43,
        ...
        series: [
          ...
          //     data: [{y: null}, {y: Number((lastSeason_totalSum - limitedArraySum(lastSeason_com, todayLength) - limitedArraySum(lastSeason_light, todayLength)
          //                                                                 - limitedArraySum(lastSeason_hvac, todayLength) - limitedArraySum(lastSeason_etc, todayLength)).toFixed(2))}],
          //     linkedTo: ':previous'
          // },
          // {
          //     name: '컴퓨터',
          //     data: [{y: limitedArraySum(lastSeason_com, todayLength), color: comparing_breakdownColors[0]}, {y: limitedArraySum(today_com, todayLength), color: today_breakdownColors[0]}]
          // }
          // , {
          //     name: '전등',
          //     data: [{y: limitedArraySum(lastSeason_light, todayLength), color: comparing_breakdownColors[1]}, {y: limitedArraySum(today_light, todayLength), color: today_breakdownColors[1]}]
          // },
          {
              name: '난방',
              data: [{y: limitedArraySum(lastSeason_hvac, todayLength), color: comparing_breakdownColors[2]}, {y: limitedArraySum(today_hvac, todayLength), color: today_breakdownColors[2]}]
          }
          // , {
          //     name: '기타',
          //     data: [{y: limitedArraySum(lastSeason_etc, todayLength), color: comparing_breakdownColors[3]}, {y: limitedArraySum(today_etc, todayLength), color: today_breakdownColors[3]}]
          // }
        ],
