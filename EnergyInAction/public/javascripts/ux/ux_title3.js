...
// console.log(month+day);
    ...
    var title=$("<div>").attr("id","title").css({"width" : "1810", "float": "left","clear":"none","font-size": "40px","font-weight": "bolder","text-align": "center", "padding-top" : "7px"}).text("UX 전력 사용 현황").css('color','rgba(256,256,256,0.5)');
