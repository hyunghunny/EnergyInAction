...
$(function () {
  ...
  thisMonth_query = 'api/labs/ux/energy/daily.json?day_from=' + DAY_FROM_MANUALLY + '&day_to=' + dateFormatter(new Date(yesterDay)) + '&offset=0';
  // thisMonth_query = 'api/labs/ux/energy/daily.json?day_from=' + dateFormatter(new Date(firstDayOfThisMonth)) + '&day_to=' + dateFormatter(new Date(yesterDay)) + '&offset=0';
  // thisMonth_query = 'api/labs/ux/energy/daily.json?day_from=' + '2015-12-01' + '&day_to=' + '2015-12-31' + '&offset=0';
  ...
  function writeText(){
    ...
    // console.log("1",LAST_SEASON_WEEKDAY_COM)
    // console.log("2",LAST_SEASON_WEEKDAY_LIGHT)
    // console.log("3",LAST_SEASON_WEEKDAY_HVAC)
    //
    // console.log("4",LAST_SEASON_WEEKEND_COM)
    // console.log("5",LAST_SEASON_WEEKEND_LIGHT)
    // console.log("6",LAST_SEASON_WEEKEND_HVAC)
