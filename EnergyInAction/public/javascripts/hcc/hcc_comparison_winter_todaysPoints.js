$(function () {
    ...
    function writeText(){
      ...
      var savingPoints=$("<div>").css({"font-size": "20px", "display" : "inline", "color": "gray", "padding-right" : "40px"}).text('절전 점수');
